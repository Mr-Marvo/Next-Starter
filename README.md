# Next Js + Tailwind Quick Starter Template

This template provides a single section layout setup to get Nextjs working with Tailwind css. Design and Developed by Mr.Marvo.
...
```bash
  ...
  git clone https://github.com/Mr-Marvo/Next-Starter.git
  cd next-starter
...
You can learn more about ReactJs, NextJs, Angular, TailwindCss and more from my github. So please hit [Follow](https://github.com/login?return_to=https%3A%2F%2Fgithub.com%2FMr-Marvo) button.
